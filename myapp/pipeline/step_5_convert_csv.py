...
# with open('json-output.json', 'r', encoding='utf-8') as json_file:
...
# pipeline/step_5_convert_csv.py
import json
import csv
...
csv_header = [
    ...
    "Transaction ValueType", "Transaction IBAN Partner", "Transaction InitialSold",
    "Transaction FinalSold"
]
                ...
                for daily in daily_summaries:
                    ...
                    if transactions:
                        ...
                        transaction_data = {
                            ...
                            "Transaction InitialSold": "", "Transaction FinalSold": ""
                        }
                        row = {**statement_data, **daily_data, **transaction_data}
                        writer.writerow(row)
            else:
